...
$("#searchBtn").on("click", function() {
    ...
    .then((data) => {
        ...
        for (var i = 0; i < 5; i++) {
            ...
            let drinkTypeEl = document.querySelector(`#drink-type` + i);
            let iconEl = document.getElementById('drink-pic' + i);

            drinkTypeEl.innerHTML = drinkType;
            iconEl.setAttribute("src", drinkPic);
